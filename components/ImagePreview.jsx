  ...
  return (
    <div className="flex flex-col items-center mt-8">
      ...
      onMouseLeave={handleMouseUp}
        >
          <Image src="/preview.png" alt="Preview" layout="fill" objectFit="contain" ref={imgRef} onMouseDown={handleMouseDown}  style={{
          position: 'absolute',
          top: position.y,
          left: position.x,
      ...
      <div className="flex justify-center mb-6 space-x-4">
        <button onClick={zoomOut} className="bg-blue-500 text-white py-2 px-4 rounded-md">
          -
        </button>
        <button onClick={zoomIn} className="bg-blue-500 text-white py-2 px-4 rounded-md">
          +
        </button>
        <button className="bg-blue-500 text-white py-2 px-4 rounded-md">Select Photo</button>
        <button className="bg-blue-500 text-white py-2 px-4 rounded-md">Add Text</button>
        <button className="bg-blue-500 text-white py-2 px-4 rounded-md">How?</button>
      </div>
      <div className="text-sm">
        By uploading an image you agree to our <a href="#" className="text-blue-500">Terms of Service</a>.
      </div>
    </div>
  );
};
